    ...
    <div style={{ background: "#f1e9dc" }}>
      ...
      >
        ...
        <div className="relative mx-auto flex min-h-[88vh] w-full max-w-[1200px] flex-col px-5 py-14 sm:px-8 md:min-h-[96vh] md:py-20">
          <div
            className="mx-auto mt-2 w-full max-w-4xl pt-2 -translate-y-6 md:-translate-y-10 lg:-translate-y-14"
          ...
          >
            ...
            <p className="mx-auto mt-8 font-display text-lg italic text-[#454545] md:text-[1.35rem]">{homepage.startLine}</p>
          </div>
