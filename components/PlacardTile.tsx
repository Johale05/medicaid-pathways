...
export default function PlacardTile({ href, title, subtitle, className }: PlacardTileProps) {
  return (
    <Link
      href={href}
      className={`flex h-full min-h-[140px] w-full max-w-[420px] flex-col justify-start rounded-[1rem] border border-[#d9ccb7]/40 bg-[#f5ede0]/95 p-6 no-underline shadow-[0_8px_20px_rgba(0,0,0,0.08)] transition-all duration-200 hover:-translate-y-[1px] hover:shadow-[0_10px_26px_rgba(0,0,0,0.10)] ${className ?? ""}`}
    >
